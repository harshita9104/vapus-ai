...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "routeBasePath": "/",
          "editUrl": "https://github.com/vapusai/vapus-ai/tree/main/app/docs/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    "image": "img/vapusai-social-card.jpg",
    "navbar": {
      "title": "VapusAI",
      "logo": {
        "alt": "VapusAI Logo",
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 VapusAI, Inc. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
